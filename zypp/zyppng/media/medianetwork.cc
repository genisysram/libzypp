...
namespace zyppng {
  ...
  struct MediaNetwork::Request : public zypp::proto::Request {
 ...
 */
  ...
  void MediaNetwork::trackRequest ( DispatchContext &ctx, Request &req ) const
  {
    ...
    while ( retry ) {
      ...
      if ( !req.result() ) {
        result = ctx.waitFor<zypp::proto::DownloadFin>( req.requestid(), std::bind( &MediaNetwork::handleStreamMessage, this, std::placeholders::_1, std::placeholders::_2 ) );
  ...
  void MediaNetwork::retryRequest ( DispatchContext &ctx, MediaNetwork::Request &req ) const
  {
    ...
    *req.mutable_settings() = _settings.protoData();
    ...
    const auto &s = ctx.waitForStatus( req.requestid(), std::bind( &MediaNetwork::handleStreamMessage, this, std::placeholders::_1, std::placeholders::_2 ) );
  ...
  void MediaNetwork::getFile(const zypp::filesystem::Pathname &filename, const zypp::ByteCount &expectedFileSize_r) const
  {
    ...
    if ( !downloadReq ) {
      ...
      const auto &s = ctx->waitForStatus( newReq.requestid(), std::bind( &MediaNetwork::handleStreamMessage, this, std::placeholders::_1, std::placeholders::_2 ) );
  ...
  void MediaNetwork::getFiles( const std::vector<std::pair<zypp::filesystem::Pathname, zypp::ByteCount> > &files ) const
  {
